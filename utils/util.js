...
/*      async: false,  */
    success: function (res) {
      ...
      wx.request({
        /*  async: false,  */
        url: app.globalData.domain + '/wx/user/login?code=' + res.code + '&sellerId=' + app.globalData.shopId,
        data: {},
  ...
  wx.getUserInfo({
    success: function (res) {
      ...
      _self.requestByLogin({
        url: 'http://restaurant.wegtech.cn/wx/user',
        method: 'POST',
        data: res.userInfo,
        // header: {
